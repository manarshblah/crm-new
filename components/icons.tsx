...
// --- ICONS ---
// (Self-contained SVG components for icons to avoid dependencies)
...
export const HandshakeIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="m11 17 2 2a1 1 0 1 0 3-3"/><path d="m14 14 2.5 2.5a1 1 0 1 0 3-3l-3.88-3.88a3 3 0 0 0-4.24 0l-.88.88a1 1 0 1 1-3-3l2.81-2.81a5.79 5.79 0 0 1 7.07 2.83l.22.22"/><path d="m7 21 2.5-2.5a1 1 0 1 0-3-3l-3.88-3.88a3 3 0 0 1 0-4.24l.88-.88a1 1 0 1 0-3-3l-2.81 2.81a5.79 5.79 0 0 0 2.83 7.07l.22.22"/></svg>
);
...
export const FilterIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><polygon points="22 3 2 3 10 12.46V19l4 2v-8.54L22 3z"/></svg>
);
...
export const WhatsappIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" {...props}><path d="M16.75 13.96c.25.13.43.2.5.33.07.13.07.68-.16 1.32-.23.64-.75 1.16-1.32 1.25-.57.1-1.25.1-1.88-.07-.63-.16-1.5-.43-2.63-1.02-1.13-.6-2.03-1.4-2.75-2.43-.72-1.03-1.2-2.2-1.32-2.88-.13-.7.1-1.32.33-1.75.23-.43.5-.57.64-.57.13 0 .26 0 .38.03.13.03.26.03.35.3.1.26.43 1.02.46 1.1.03.07.03.16 0 .23-.03.07-.13.13-.26.26-.13.13-.23.23-.3.3-.07.07-.13.13-.07.23s.26.43.53.7c.26.26.6.6.98.9.38.3.6.46.7.53.1.07.16.03.23-.03.07-.03.3-.35.43-.46s.23-.2.3-.23c.07-.03.13-.03.2 0 .07 0 .8.38 1.05.46.25.1.4.16.43.23.03.07 0 .5-.04.53zM12 2a10 10 0 1 0 10 10 10 10 0 0 0-10-10zM8.13 17.18c.5.53 1.1 1 1.75 1.4a6 6 0 0 1-3.2-.8l-.33.2-.8 2.36 2.3-.8.2-.36zm7-1.36c.86-.53 1.5-1.25 1.92-2.12.43-.88.64-1.84.64-2.82a6.32 6.32 0 0 0-1.05-3.6A6.23 6.23 0 0 0 12 4a6.2 6.2 0 0 0-4.38 1.82A6.35 6.35 0 0 0 6.5 12c0 1.65.6 3.2 1.8 4.35a6.2 6.2 0 0 0 4.38 1.82c.2 0 .4 0 .6-.05a4.7 4.7 0 0 0 1.85-.7z"/></svg>
);
...
export const DealIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 22a7 7 0 0 0 7-7h-4a3 3 0 0 1 -3-3V8a3 3 0 0 1-6 0 3 3 0 0 1 3-3h4a7 7 0 0 0-7-7 7 7 0 0 0-7 7v4a3 3 0 0 1 3 3 3 3 0 0 1-3 3v4a7 7 0 0 0 7 7z"/></svg>
);
...
export const MoveVerticalIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><polyline points="8 18 12 22 16 18"/><polyline points="8 6 12 2 16 6"/><line x1="12" x2="12" y1="2" y2="22"/></svg>
);